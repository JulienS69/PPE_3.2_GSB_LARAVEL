<!-- Vue permettant l'affichage d'un message de réussite pour la validation d'une fiche de frais
renseigné par un visiteur dans la base de données. [Route N°4, méthode store]
-->
