...
<div class="container">
<!-- Bouton Connexion, Inscription, Accueil au cas ou ceux ajoutés auraient des problèmes.
...
@auth
        ...
        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline" style="color: #1d68a7">Se
            ...
            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline"
                       style="color: #1d68a7">S'inscrire</a>
                @endif
    @endauth
        </div>
    @endif
    ...
    <img src="images/logo-gsb.png" style="position: absolute">
